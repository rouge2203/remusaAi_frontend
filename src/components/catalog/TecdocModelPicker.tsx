import type { TecdocModelOption } from "../../types";

export default function TecdocModelPicker({
  options,
  onSelect,
}: {
  options: TecdocModelOption[];
  onSelect: (o: TecdocModelOption) => void;
}) {
  ...
  return (
    <div className="rounded-2xl border border-amber-200/90 bg-amber-50/90 p-3 shadow-sm">
      ...
      <p className="mb-2 px-1 text-xs text-amber-900/80">
        El VIN coincide con varios modelos. Seleccione uno para cargar las variantes (motor / año).
      </p>
